...
function toConf (settings, defaults) {
  ...
  conf.unshift(
    '# Generated by https://saiy2k.github.io/lightning-node-config-generator/\n',
    '# This config should be placed in following path:',
    `# ${configPath}`,
    `The default location of this file can be overwritten by specifying the --configfile= flag when starting lnd.`
  );
